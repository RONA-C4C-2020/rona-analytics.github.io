var api_url = "https://ndegwaofficial.github.io/Rona.github.io/all.json";
...
function getAllCountryGraphs() {
  fetch("https://ndegwaofficial.github.io/Rona.github.io/Rona-Timeseries.json")
      ...
      datasets: [
        {
          ...
          data: ylabels,
          backgroundColor: ["rgba(79,185,190,0.84)"],
          borderColor: ["rgb(48,184,230)"],
          lineTension: 0.4,
          borderWidth: 1,
          pointRadius: 2,
          pointBackgroundColor: "rgba(92,225,230,0.8)"
        }
      ]
    },
    options: {
